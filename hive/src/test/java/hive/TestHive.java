...
public class TestHive {
    ...
    public static void main(String[] args) throws Exception {
        ...
        testHive.init();
        testHive.descTable("student1");
        //testHive.selectData("select t.name,count(*) from (select * from student stu where stu.cid in (select id from class)) as t group by t.name");
